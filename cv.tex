...
\begin{EntriesTableDurationBack}
  ...
  \begin{itemize}[label={-}, leftmargin=*] % 使用 - 作为项目符号，leftmargin=* 使缩进与文本对齐
    ...
    \item \textit{Leading teams through the entire process of Electrical Resistivity Tomography (ERT) survey design, data acquisition, data processing, and data interpretation}.
    \item \textit{Using the open Python package SimPEG process potential difference data to obtain conductivity cross-section}.
    \item \textit{Using the Smart Seismic Sensor IGU-16HR, seismic data from both active and passive sources were successfully collected}.
  ...
  \begin{itemize}[label={-}, leftmargin=*]
    ...
    \item \textit{In a short period, generate a high-resolution underground resistivity model and interactively adjust it using prior information}.
  \end{itemize}
  \\
  &
  ...
  \begin{itemize}[label={-}, leftmargin=*] 
    ...
    \item \textit{The spatial positions of the cavities were successfully identified by leveraging conductivity and velocity models, respectively}.
  ...
  \begin{itemize}[label={-}, leftmargin=*] 
    % \item \textit{The deep resolution of the resistivity model was enhanced by utilizing a monitoring well as a current electrode}.
